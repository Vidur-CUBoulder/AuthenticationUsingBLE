...
void GPIO_EVEN_IRQHandler(void)
{
  ...
  if(intFlags & (1<<12))
  {
    ...
    {
      trial_packet.cmd_list_enum = do_action;
      trial_packet.action_cmd_list_enum = send_pin;
#ifdef CREATE_MESSAGE_PACKET
      create_msg_packet(trial_packet, keypad_input_buffer);
#endif
